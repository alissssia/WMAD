...
public class ControllerServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        actionMap.put("/purchase.do", new purchaseAction((ProductModel) context.getAttribute("productModel"),(PurchaseModel) context.getAttribute("purchaseModel")));
        actionMap.put("/register.do", new registerAction((UserModel) context.getAttribute("userModel")));
        actionMap.put("/login.do", new loginAction((UserModel) context.getAttribute("userModel")));
        actionMap.put("/logout.do", new logoutAction());
        actionMap.put("/history.do", new historyAction((PurchaseModel) context.getAttribute("purchaseModel")));
